  ...
  <c:forEach var="bak" items="${baks }" >
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="19%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE10">${bak.operater.opName }</span></div></td>
        <td width="19%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE10">${bak.bakDate }</span></div></td>
        ...
        <td height="19%" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="bak.sys?method=restore&&fileName=${bak.path }" class="normalrestore">还原</a>|<a href="bak.sys?method=del&&id=${bak.bakId }&&status=queryList&&opName=${operaterName}&&upDate=${upDate}&&downDate=${downDate}&&page=${pageDivid.currentPage }" class="normaldel" opName="${bak.operater.opName }">删除</a>
      ...
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
          	...
          	<c:if test="${pageDivid.currentPage!=1 }">
          		 <td width="49"><div align="center"><a href="bak.sys?method=queryByCondition&&opName=${operaterName}&&upDate=${upDate}&&downDate=${downDate}&&page=1"><img src="/personnel/comm/images/comm/main_54.gif" width="40" height="15" /></a></div></td>
          		  <td width="49"><div align="center"><a href="bak.sys?method=queryByCondition&&opName=${operaterName}&&upDate=${upDate}&&downDate=${downDate}&&page=${pageDivid.currentPage-1 }"><img src="/personnel/comm/images/comm/main_56.gif" width="45" height="15" /></a></div></td>
          	</c:if>
          	...
          	<c:if test="${pageDivid.currentPage!=pageDivid.allPage }">
          		  <td width="49"><div align="center"><a href="bak.sys?method=queryByCondition&&opName=${operaterName}&&upDate=${upDate}&&downDate=${downDate}&&page=${pageDivid.currentPage+1 }"><img src="/personnel/comm/images/comm/main_58.gif" width="45" height="15" /></a></div></td>
           		  <td width="49"><div align="center"><a href="bak.sys?method=queryByCondition&&opName=${operaterName}&&upDate=${upDate}&&downDate=${downDate}&&page=${pageDivid.allPage }"><img src="/personnel/comm/images/comm/main_60.gif" width="40" height="15" /></a></div></td>
          	</c:if>
            ...
            <td width="35"><a href="bak.sys?method=queryByCondition&&opName=${operaterName}&&upDate=${upDate}&&downDate=${downDate}&&page=" id="tiao"><img src="/personnel/comm/images/comm/main_62.gif" width="26" height="15" /></a></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
