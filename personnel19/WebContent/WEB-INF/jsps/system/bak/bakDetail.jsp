	...
	<input type="hidden" name="id" value="${bak.bakId }"/>
		...
		<table class="centtable_style" cellspacing="1px">
			...
			<tr>
				...
				<td class="centtr"><input size="40" type="text" value="${bak.path }" disabled="disabled" name="fileName"/></td>
			</tr>
			<tr>
				<td class="toptr">备份描述</td>
				<td class="centtr"><textarea rows="0.5" cols="33" disabled="disabled" name="remark">${bak.bakRemark }</textarea></td>
			</tr>
		</table>
	</form>
