...
<body>
	<form action="duty.sys?method=addduty" method="post">
		...
		<table class="centtable_style" cellspacing="1px">
			<tr>
				...
				<td class="centtr"><input type="text" id="fileName" name="dutyName" size="40"/><span style="color:red;" id="tixing"></span></td>
			</tr>
		</table>	
	</form>
</body>
