...
<body>
	<form action="duty.sys?method=edit" method="post">
	<input type="hidden" name="dutyId" value="${duty.dutyId }"/>
		<table class="toptable_style">
			<tr>
				<td width="85%"><img src="/personnel/comm/images/comm/tb.gif" />
					<span class="title_style">修改职称信息</span></td>
		...
		<table class="centtable_style" cellspacing="1px">
			...
			<tr>
				...
				<td class="centtr"><input size="40" type="text" value="${duty.dutyName }" name="dutyName" id = "fileName"/><span style="color:red;" id="tixing"></span></td>
			</tr>
