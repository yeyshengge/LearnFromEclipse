...
function(){
	...
	$("a.checkItem").click(function(){
		...
		if(flag){
			//form表单提交
			$("form").attr("action","djr.sys?method=del");
			$("form").submit();
		}
		return false;
	});
	...
	$("a#Topedit").click(function(){
		...
		if(flag){
			$("form").attr("action","djr.sys?method=jumpEdit");
			$("form").submit();
		}
		return false;
	});
	...
	$("a#tiao").click(function(){
		...
		if($("input#textfield").val()<1||$("input#textfield").val()>$("input[name=allpage]").val()){
			...
			$("a#tiao").attr("href","djr.sys?method=queryByCondition&&departmentId=${departmentId}&&page="+$("input#textfield").val());
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 职位列表</span></td>
              </tr>
            </table></td>
            <td><div align="right"><span class="STYLE1">
               <input type="checkbox" name="checkbox11" class="checkbox11" />
              全选      &nbsp;&nbsp;
              <a href="djr.sys?method=query" class="white" ><img src="/personnel/comm/images/comm/add.gif" width="10" height="10" /> 返回 &nbsp;</a> 
  ...
  <c:forEach var="deptJobRel" items="${deptJobRels }" >
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <!-- | --><a href="djr.sys?method=del&&deptJobRelId=${deptJobRel.deptJobRelId }" class="normaldel" >删除</a>
         |<a href="djr.sys?method=jumpEdit&&deptJobRelId=${deptJobRel.deptJobRelId }" class="normaledit" ">编辑</a>
      ...
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
          	...
          	<c:if test="${pageDivid.currentPage!=1 }">
          		 <td width="49"><div align="center"><a href="djr.sys?method=queryByCondition&&departmentId=${departmentId}&&page=1"><img src="/personnel/comm/images/comm/main_54.gif" width="40" height="15" /></a></div></td>
          		  <td width="49"><div align="center"><a href="djr.sys?method=queryByCondition&&departmentId=${departmentId}&&page=${pageDivid.currentPage-1 }"><img src="/personnel/comm/images/comm/main_56.gif" width="45" height="15" /></a></div></td>
          	</c:if>
          	...
          	<c:if test="${pageDivid.currentPage!=pageDivid.allPage }">
          		  <td width="49"><div align="center"><a href="djr.sys?method=queryByCondition&&departmentId=${departmentId}&&page=${pageDivid.currentPage+1 }"><img src="/personnel/comm/images/comm/main_58.gif" width="45" height="15" /></a></div></td>
           		  <td width="49"><div align="center"><a href="djr.sys?method=queryByCondition&&departmentId=${departmentId}&&page=${pageDivid.allPage }"><img src="/personnel/comm/images/comm/main_60.gif" width="40" height="15" /></a></div></td>
          	</c:if>
