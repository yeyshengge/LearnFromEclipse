...
function(){
	...
	$("a#tiao").click(function(){
		...
		if($("input#textfield").val()<1||$("input#textfield").val()>$("input[name=allpage]").val()){
			...
			$("a#tiao").attr("href","djr.sys?method=query&&page="+$("input#textfield").val());
        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
              ...
              全选      &nbsp;&nbsp;
               <a href="djr.sys?method=jumpQuery" class="white" ><img src="/personnel/comm/images/comm/add.gif" width="10" height="10" /> 查询 &nbsp;</a> 
      ...
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
          	...
          	<c:if test="${pageDivid.currentPage!=1 }">
          		 <td width="49"><div align="center"><a href="djr.sys?method=query&&page=1"><img src="/personnel/comm/images/comm/main_54.gif" width="40" height="15" /></a></div></td>
          		  <td width="49"><div align="center"><a href="djr.sys?method=query&&page=${pageDivid.currentPage-1 }"><img src="/personnel/comm/images/comm/main_56.gif" width="45" height="15" /></a></div></td>
          	</c:if>
          	...
          	<c:if test="${pageDivid.currentPage!=pageDivid.allPage }">
          		  <td width="49"><div align="center"><a href="djr.sys?method=query&&page=${pageDivid.currentPage+1 }"><img src="/personnel/comm/images/comm/main_58.gif" width="45" height="15" /></a></div></td>
           		  <td width="49"><div align="center"><a href="djr.sys?method=query&&page=${pageDivid.allPage }"><img src="/personnel/comm/images/comm/main_60.gif" width="40" height="15" /></a></div></td>
          	</c:if>
