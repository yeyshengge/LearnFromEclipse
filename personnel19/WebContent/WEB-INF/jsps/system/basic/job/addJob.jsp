...
<body>
	<form action="djr.sys?method=adddjr" method="post">
		...
		<table class="centtable_style" cellspacing="1px">
			...
			<tr>
				<td class="toptr">职位名</td>
				<td class="centtr">
					<input size="40" type="text" name="jobName" id = "fileName"/><span style="color:red;" id="tixing"></span>
				</td>
			</tr>
		</table>	
	</form>
