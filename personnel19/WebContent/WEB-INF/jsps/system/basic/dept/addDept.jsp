...
<body>
	<form action="dept.sys?method=addDept" method="post">
		...
		<table class="centtable_style" cellspacing="1px">
			<tr>
				...
				<td class="centtr"><input type="text" id="fileName" name="deptName" size="40"/><span style="color:red;" id="tixing"></span></td>
			</tr>
		</table>	
	</form>
</body>
