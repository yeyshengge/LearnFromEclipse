...
<script type="text/javascript"
	src="/personnel/comm/js/person/personAppraise/personAppraiseByDept.js"></script>
...
<body>
	...
	<div>
		...
		<div id="query" align="center">
			...
			<a href="personAppraise.per?method=findAll&state=0">查询所有</a> 
			<form>
				...
				<table width="312" border="0" style="margin-left: 153px;"
					...
					<tr>
						<td width="49"><div align="center">
								<a href="personAppraise.per?method=findAll&state=1&currentPage=1&departmentName=${departmentName }">
						...
						<c:if test="${currentPage ne 1 }">
							<td width="49">
								<div align="center">
									<a
										href="personAppraise.per?method=findAll&state=1&currentPage=${currentPage-1 }&departmentName=${departmentName }">
						...
						<td width="49"><div align="center">
								<a
									href="personAppraise.per?method=findAll&state=1&currentPage=${allPage }&departmentName=${departmentName }">
