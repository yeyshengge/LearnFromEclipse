...
<center>
	...
	<form action="?method=specific" method="POST">
		...
		<table cellpadding="10px">
			...
			<tr>
				<td>年份：</td>
				<td align="left"><input type="text" id="year" name="year" value="" /> <br /></td>
				<td>月份:</td>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="topUp">
    	...
    	<c:if test="${!payrolllist.isEmpty()}">
		<tr>
		  	<td>
		  		<c:forEach var="payrolllist" items="${payrolllist}" varStatus="status">
	  			<tr>
	   				<td>
	  			  		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	     					<tr>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       					 	<span class="STYLE10"><span>${payrolllist.getYear()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       						<span class="STYLE10"><span>${payrolllist.getMonth()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       					 	<span class="STYLE10"><span>${payrolllist.getSalary().getBonus()==null? 0:payrolllist.getSalary().getBonus()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       						<span class="STYLE10"><span>${payrolllist.getSalary().getLunchSalary()==null?0:payrolllist.getSalary().getLunchSalary()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       					 	<span class="STYLE10"><span>${payrolllist.getSalary().getTrafficSalary()==null?0:payrolllist.getSalary().getTrafficSalary()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       						<span class="STYLE10"><span>${payrolllist.getSalary().getBasicSalary()==null?0:payrolllist.getSalary().getBasicSalary()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       					 	<span class="STYLE10"><span>${payrolllist.getSalary().getTrafficSalary()==null?0:payrolllist.getSalary().getAllSalary()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       						<span class="STYLE10"><span>${payrolllist.getPbtimes()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       					 	<span class="STYLE10"><span>${payrolllist.getTotal()}</span></span></div></td>
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       						<span class="STYLE10"><span><button type="button" onclick="window.open('?method=detailed&workid=${person.getWorkId()}&year=${payrolllist.getYear()}&month=${payrolllist.getMonth()}','_blank');">详情</button></span></span></div></td>
	     					 </tr>
	   					</table>
	   				</td>
	 			</tr>
	   				...
	   				<td>
	  			  		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	     					<tr>
	       						...
	       						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">
	       						<span class="STYLE10"><span><button type="button" onclick="window.open('?method=detailed&workid=${person.getWorkId()}&year=${payrollone.getYear()}&month=${payrollone.getMonth()}','_blank');">详情</button></span></span></div></td>
	     					 </tr>
	   					</table>
	   				</td>
	 			</tr>
