...
public class ChessGame extends JFrame implements MouseListener, Runnable {
	...
	public ChessGame() {
		...
		String imagePath = "" ;
		try {
			imagePath = System.getProperty("user.dir")+"/bin/image/White.jpg" ;
