...
<div>
	<ul >
		...
		<li style="width: 80px;
		list-style-type:none;
		float: right;"><img style="width: 30px;margin-top: 15px" src="img/u1246.png"></li>
		<li  id="test4" style="width: 80px;
		list-style-type:none;
		float: right;color:white" >个人中心</li>
...
<div class="df1">
	<div class="df2">
		<img style="width: 249px; height: 199px; border: 1px solid red;"  src="img/机构logo/机构logo.jpg" />
				
		<p align="center">这里是机构名称</p>
	</div>
	<div class="df2">
		<img style="width: 249px; height: 199px; border: 1px solid red;" src="img/机构logo/机构logo.jpg" />
