...
<body>
	<form action="djr.sys?method=edit" method="post">
	<input type="hidden" name="deptJobRelId" value="${deptJobRel.deptJobRelId }"/>
		<table class="toptable_style">
			<tr>
				<td width="85%"><img src="/personnel/comm/images/comm/tb.gif" />
					<span class="title_style">修改职位信息</span></td>
		...
		<table class="centtable_style" cellspacing="1px">
			...
			<tr>
				...
				<td class="centtr"><input size="40" type="text" value="${deptJobRel.department.departmentName }" name="departmentName" id = "fileName2" disabled="disabled"/><span style="color:red;" ></span></td>
			</tr>
			<tr>
				<td class="toptr">职称名</td>
				<td class="centtr"><input size="40" type="text" value="${deptJobRel.job.jobName }" name="jobName" id = "fileName"/><span style="color:red;" id="tixing"></span></td>
			</tr>
		</table>
	</form>
