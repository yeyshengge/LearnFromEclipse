...
<body>
	<form action="bak.sys?method=addBak" method="post">
		...
		<table class="centtable_style" cellspacing="1px">
			<tr>
				<td class="toptr">备注备份</td>
				<td class="centtr"><textarea rows="0.5" cols="33" name="remark"></textarea></td>
			</tr>
			<tr>
				<td class="toptr">文件名</td>
				<td class="centtr"><input type="text" id="fileName" name="fileName" size="40"/><span style="color:red;" id="tixing"></span></td>
			</tr>
