...
<body>
	...
	<form action="bak.sys?method=queryByCondition" method="post">
		<table class="toptable_style">
			<tr>
				<td width="85%"><img src="/personnel/comm/images/comm/tb.gif" />
					<span class="title_style">备份查询</span></td>
				<td><span class="title_style"><img
						src="/personnel/comm/images/comm/add.gif" /><input type="submit" value="查询" id="add"> </span></td>
