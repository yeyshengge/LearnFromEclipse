...
<body>
		<table>
			<tr>
				...
				<td><a href="/personnel/page.inf?method=pagingEn&curPage=1"><img
						src="/personnel/comm/images/comm/main_54.gif" /></a></td>
				<td><a href="/personnel/page.inf?method=pagingEn&curPage=${page.curPage-1}&way=up"><img
						src="/personnel/comm/images/comm/main_56.gif" /></a></td>
				<td><a href="/personnel/page.inf?method=pagingEn&curPage=${page.curPage+1}&way=down"><img
						src="/personnel/comm/images/comm/main_58.gif" /></a></td>
				<td><a href="/personnel/page.inf?method=pagingEn&curPage=${page.pageNum}"><img
