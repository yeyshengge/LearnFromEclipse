...
<script type="text/javascript"
	src="comm/js/person/personTrain/personTrain.js"></script>
<script language="javascript" type="text/javascript"
	src="comm/calenderController/My97DatePicker/WdatePicker.js"></script>
<link rel="text/javascript">

<link type="text/css" href="comm/css/person/personTrain/personTrain.css"
	rel="stylesheet" />
<title>员工培训管理</title>
</head>
<body>
		...
		<div id="pTrainTitle">
			...
			<div class="titleButton">
				<img class="titleButtonImage"
					...
					<a href="" class="titleButtonText1">导入Excel</a><!-- 路径怎么找？ -->
				...
				<table width="312" border="0"
					...
					<tr>
						<td width="49"><div align="center">
								<a href="personTrain.per?method=findAll&state=0&currentPage=1"> <img
						...
						<c:if test="${currentPage ne 1 }">
							<td width="49">
								<div align="center">
									<a
										href="personTrain.per?method=findAll&state=0&currentPage=${currentPage-1 }">
						...
						<td width="49"><div align="center">
								<a href="personTrain.per?method=findAll&state=0&currentPage=${allPage }">
						...
						<div>
							<form id="formid" action="personTrain.per?method=save"
								...
								<div id="personnelTrainRemark">
									备注：<input name="input4" type="text">
								</div>
								<div id="button">
