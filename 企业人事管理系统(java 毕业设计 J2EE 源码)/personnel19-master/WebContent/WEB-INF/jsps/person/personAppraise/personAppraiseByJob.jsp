...
<script type="text/javascript"
	src="/personnel/comm/js/person/personAppraise/personAppraiseByJob.js"></script>
				...
				<table width="312" border="0" style="margin-left: 153px;"
					...
					<tr>
						<td width="49"><div align="center">
								<a href="personAppraise.per?method=findAll&state=2&currentPage=1&jobName=${jobName }">
						...
						<c:if test="${currentPage ne 1 }">
							<td width="49">
								<div align="center">
									<a
										href="personAppraise.per?method=findAll&state=2&currentPage=${currentPage-1 }&jobName=${jobName }">
						...
						<td width="49"><div align="center">
								<a
									href="personAppraise.per?method=findAll&state=2&currentPage=${allPage }&jobName=${jobName }">
