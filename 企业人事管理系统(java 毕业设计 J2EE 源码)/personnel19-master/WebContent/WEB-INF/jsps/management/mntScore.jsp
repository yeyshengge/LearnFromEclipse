...
<form action="mntScore.man?method=pickUp" method="post">
<table cellpadding="10px" bordercolor="blue">
<tr>
<td>编号：</td><td align="left"><input type="text" name="pNo"></td>
...
<table class="centtable_style" cellspacing="1px">
   ...
   <c:forEach var="p" items="${persons2}" varStatus="a" begin="${i}" end="${i+9}">
   <tr class="centtr">
       <td>${p.personnelNo}</td>
...
<form action="mntScore.man?method=turnPage&num=jump" method="post">
		<table>
			<tr>
				<td><div id="pagestyle"></div></td>
				<td><a href="mntScore.man?method=turnPage&num=first"><img
						src="/personnel/comm/images/comm/main_54.gif" /></a></td>
				<td><a href="mntScore.man?method=turnPage&num=up"><img
						src="/personnel/comm/images/comm/main_56.gif" /></a></td>
				<td><a href="mntScore.man?method=turnPage&num=down"><img
						src="/personnel/comm/images/comm/main_58.gif" /></a></td>
				<td><a href="mntScore.man?method=turnPage&num=last"><img
