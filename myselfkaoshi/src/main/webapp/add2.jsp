		...
		align="center">
			...
			<tbody>
				<tr>
					...
					<td>
						<input id="username" type="text" name="ename" value="" required >
						
					</td>
				</tr>
				<tr>
					<td>部门</td>
					<td><input type="text" name="deptid" value="" required ></td>
				</tr>
				<tr>
					<td>年龄</td>
				...
				<tr>
					<td>入职时间</td>
					<td><input type="date" name="workdate" value="" required></td>
				</tr>
